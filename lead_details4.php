        ...
        <div class="">
            <div class="block">
               ...
               <tr>
                ...
                <tr>
                    <th>Lead Source</th>
                    <th><?php echo $row['lead_source']; ?></th>
                </tr>
                <tr>
                    <th>Created By</th>
                ...
                <div align="center">
                    ...
                    <textarea  name="notes" id="noteid"  rows="6" cols="80"></textarea>
                ...
                <div align="center">
                    ...
                    {
                        ?>
                        <input  id="send"type="submit" name="completed" onclick="changeleadstatus('COMP',<?php echo $var1;?>)" value="Completed" <?php echo ($row['status_code'] == 'COMP') ? 'disabled' : ''; ?> />
                        <br>
                        <input  id="send"type="submit" name="incompleted" onclick="changeleadstatus('ICOM',<?php echo $var1;?>)" value="Incomplete" <?php echo ($row['status_code'] == 'ICOM') ? 'disabled' : ''; ?> />
                    ...
                    { ?>
                        ...
                        <input id="send" type="submit" name="readey to book" onclick="changeleadstatus('RDTB',<?php echo $var1;?>)" value="Qualified A1" <?php echo ($row['status_code'] == 'RDTB') ? 'disabled' : ''; ?> />
