	...
	for($day= 1; $day <= 7; $day++) {
		...
		echo '<td>';
			...
			if (empty($var_book1_match) and $var_book1_match==0 )
			{
				...
				echo "<input type='button' name='Book1' value='Book1&nbsp;&nbsp;&nbsp;&nbsp;' style='width:55px; height:25px;  background-color: #99ccff'/>&nbsp;&nbsp;";
			...
			{
				echo "<input type='button' name='Book2' value='Book2&nbsp;&nbsp&nbsp;&nbsp;' style='width:55px; height:25px;  background-color: #99ccff'/>&nbsp;&nbsp;";
			...
			{
				echo "<input type='button' name='Book3' value='Book3&nbsp;&nbsp;&nbsp;&nbsp' style='width:55px; height:25px;  background-color: #99ccff'/>&nbsp;&nbsp;";
				//echo 'book3';  echo $row["id"];
			}
			else
			{
			...
			{
				echo "<input type='button' name='Book4' value='Book4&nbsp;&nbsp;&nbsp;&nbsp' style='width:55px; height:25px;  background-color: #99ccff'/>&nbsp;&nbsp;";
