...
<body>
    <div class="container_12">
        ...
        <div class="grid_10">
            ...
            <div class="box round first">
                <h2>
                    All Enquiries&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				 ...
				 &nbsp&nbsp&nbsp&nbsp
				 <input id="send" type="submit" name="delete_selected" value="Delete Selcted" onClick="delete_selected()" style="width: 100px" size=1/>
				 &nbsp&nbsp&nbsp&nbsp
				  <input id="send" type="submit" value=" Reset Search"style="width: 150px" size=1 name="submit" />&nbsp&nbsp&nbsp&nbsp
	...
	<?php include('excel_export2.php'); ?>
			...
			{
			$select_query = "select i.ID, i.insert_time,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes,ifnull(lse.status_code,'NEW') status_code from insulations i left outer join lead_status_event lse on i.ID = lse.id order by id desc";
