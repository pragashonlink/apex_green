...
<div class="container_12">
    ...
    <div class="grid_10">
        ...
        <div class="box round first">
            <h2>
                All Completed&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            ...
            <div class="block">
                <div id="" class="completed_table">
                    ...
                    //$select_query = "select i.ID, i.insert_time,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes, status_code from lead_status_event , lead_status_event lse where i.ID = lse.id and lse.status_code='COMP' order by id desc";

                    $select_query = "select i.ID, Date_format(i.insert_time,'%d-%m-%Y %r') itime,Date_format(i.completed_date,'%d-%m-%Y') completed_date,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes from insulations i , lead_status_event lse where i.ID = lse.id and lse.status_code='COMP' order by id desc LIMIT $page1, $per_page";
                    $full_query = "select i.ID, Date_format(i.insert_time,'%d-%m-%Y %r') itime,Date_format(i.completed_date,'%d-%m-%Y') completed_date,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes from insulations i , lead_status_event lse where i.ID = lse.id and lse.status_code='COMP' order by id desc";
                    ...
                    // $res = mysqli_query($conn, "select * from insulations where status_code = 'COMP' order by id desc");
                    ...
                    while($row=mysqli_fetch_array($res)) {
                        echo "<tr bgcolor=#00b300>";
                        echo "<td>";

                        echo "<input type='checkbox'style='width: 20px; height: 20px ' data-email='".$row['email']."'  name='chkid'  value='".$row['ID']."' onClick=set_email_arr('".$row['ID']."')>";
        ...
        <input type="hidden" value="completed" id="view"/>
    </div>
    <div class="grid_5">
...
<script type="text/javascript">
    $("body .completed_table table").tablesorter({
        dateFormat: 'uk',
