...
<div class="container_12">
    ...
    <div class="grid_10">
        ...
        <div class="box round first">
            <h2>
                All Qulalified &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                ...
                if(isset($_SESSION['role']) && $_SESSION['role'] == 'ADMIN') {
                    ...
                    <!--<input id="send" type="submit" name="create_excel" value="Export list" onclick="document.location = 'excel_export2.php?status=QULI';" style="width: 100px" size=1/>-->
            ...
            <div class="block">
                <div id="employee_table">
                    ...
                    $select_query = "select i.ID, Date_format(i.insert_time,'%d-%m-%Y %r') itime,Date_format(i.completed_date,'%d-%m-%Y') completed_date,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes,ifnull(lse.status_code,'QULI') from insulations i , lead_status_event lse where i.ID = lse.id and lse.status_code='QULI' order by id desc LIMIT $page1, $per_page";
                    $full_query = "select i.ID, Date_format(i.insert_time,'%d-%m-%Y %r') itime,Date_format(i.completed_date,'%d-%m-%Y') completed_date,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes,ifnull(lse.status_code,'QULI') from insulations i , lead_status_event lse where i.ID = lse.id and lse.status_code='QULI' order by id desc";
                    //$select_query = "select i.ID, i.insert_time,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes,ifnull(lse.status_code,'QULI')  from insulations i left outer join lead_status_event lse on i.ID = lse.id order by id desc";


                    //$select_query = "select * from confirm_order_address order by id desc";

                    //$res = mysqli_query($conn, "select * from insulations where status_code = 'QULI' order by id desc");
    ...
    <div class="grid_5">
        <input type="hidden" value="qualified" id="view"/>
    </div>
    <div id="abc">
