...
<body>
    <div class="container_12">
        ...
        <div class="grid_10">
			...
			$select_query = "select id, source_name,source_desc from lead_source where active_flag='Y' ";
          ...
          // $res = mysqli_query($conn, "select * from insulations where status_code = 'REM' order by id desc");
            ...
            echo "<td style='font-weight:bold'>"; echo "Lead Source Name"; echo "</td>";
            echo "<td style='font-weight:bold'>"; echo "Lead Source Description"; echo "</td>";
            ...
            while($row=mysqli_fetch_array($res))
            {
               ...
               // echo "<td>"; echo $row["title"] . ' ' . $row["forename"] . ' ' . $row["surname"]; echo "</td>";
                ...
                echo "<td>"; echo $sno; echo "</td>";
                echo "<td>"; echo $row["source_name"]; echo "</td>";
				echo "<td>"; echo $row["source_desc"]; echo "</td>";
			?>
				<td><input type="submit" name="deactivate" value = "Remove" onclick="deactivate_source(<?php echo $row['id']; ?>)"/>
				</td>
				</tr>
				<?php
				 $sno=$sno+1;
...
function deactivate_source(src_id) {
	...
	alert (v_src_id);
      $.ajax({
           type: "POST",
           url: 'deactivate_lead_source.php',
