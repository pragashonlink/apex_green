    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            ...
            <div class="box round first">
                  ...
                  <h2 ><?php echo $num_rows ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			...
			{
			$select_query = "select i.ID,i.insert_time, Date_format(i.insert_time,'%d-%m-%Y %r') itime,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes,ifnull(lse.status_code,'NEW') status_code from insulations i left outer join lead_status_event lse on i.ID = lse.id where YEAR(insert_time) = YEAR(CURRENT_DATE()) AND MONTH(insert_time) = MONTH(CURRENT_DATE()) order by id desc";
			...
			echo "<td style='font-weight:bold'>"; echo "Job No"; echo "</td>";
            ...
            while($row=mysqli_fetch_array($res))
            {
				...
				echo "<input type='checkbox'style='width: 20px; height: 20px '  name='chkid'  value='".$row['ID']."' onClick=set_email_arr('".$row['ID']."')>";
