...
<div class="container_12">
    ...
    <div class="grid_10">
        ...
        <div class="box round first">
            <h2>
                New Jobs&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                ...
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                <input id="send" type="submit" name="emailSelected" value="Email Selected" style="width: 100px"
                       onclick="div_show()">
                &nbsp&nbsp&nbsp&nbsp
                <?php
                if(isset($_SESSION['role']) && $_SESSION['role'] == 'ADMIN') {
                    ?>
                    <input id="delete" type="submit" name="delete_selected" value="Delete Selcted"
                           onClick="delete_selected()" style="width: 100px" size=1/>
                    &nbsp&nbsp&nbsp&nbsp
                    <!--<input id="send" type="submit" name="create_excel" value="Export list" onclick="document.location = 'excel_export2.php?status=COMP';" style="width: 100px" size=1/>-->
            ...
            <div class="block">
                <div id="employee_table">
                    ...
                    //$select_query = "select i.ID, i.insert_time,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes,ifnull(lse.status_code,'RDTB')  from insulations i left outer join lead_status_event lse on i.ID = lse.id order by id desc";
                    $select_query = "select * from (select i.ID, Date_format(i.insert_time,'%d-%m-%Y %r') itime,Date_format(i.completed_date,'%d-%m-%Y') completed_date,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes,ifnull(lse.status_code,'NEW') status_code from insulations i left outer join lead_status_event lse on i.ID = lse.id) new_lead where status_code = 'NEW' order by id desc LIMIT $page1, $per_page";
                    $full_query = "select * from (select i.ID, Date_format(i.insert_time,'%d-%m-%Y %r') itime,Date_format(i.completed_date,'%d-%m-%Y') completed_date,i.title,i.forename,i.surname,i.address,i.postcode,i.phone, i.altno,i.email,i.notes,ifnull(lse.status_code,'NEW') status_code from insulations i left outer join lead_status_event lse on i.ID = lse.id) new_lead where status_code = 'NEW' order by id desc";
                    //$res = mysqli_query($conn, "select * from insulations where status_code = 'RDTB' order by id desc");
                    ...
                    while($row=mysqli_fetch_array($res))
                    {
                        ...
                        echo "<input type='checkbox'style='width: 20px; height: 20px '  name='chkid'  value='".$row['ID']."' onClick=set_email_arr('".$row['ID']."')  data-email='".$row['email']."'>";
    ...
    <input type="hidden" value="new" id="view"/>
